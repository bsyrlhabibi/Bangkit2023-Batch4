...
import com.bibi.storyapp.*
import com.bibi.storyapp.databinding.ActivityStoryBinding
        ...
        if (getFile != null) {
            ...
            if (description.isEmpty()) {
                binding.edtDesc.error =
                    resources.getString(R.string.cannot_empty_field, "description")
            } else {
            ...
            Toast.makeText(
                this,
                resources.getString(R.string.cannot_empty_field, "photo"),
                Toast.LENGTH_SHORT
            )
                .show()
        }
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == REQUEST_CODE_PERMISSIONS) {
            if (!allPermissionsGranted()) {
                Toast.makeText(
                    this,
                    getString(R.string.cannot_empty_field),
                    Toast.LENGTH_SHORT
                ).show()
                finish()
            }
